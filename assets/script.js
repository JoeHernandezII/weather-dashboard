...
function success(position) {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?lat=" + lat + "&lon=" + lon + "&appid=fa26494f744d903b68067a9947d31b33";
    $.ajax({
        url: queryURL,
        method: "GET"
...
function getCurrent(city) {
    ...
    $.ajax({
        ...
        //get UV Index
        var uvURL = "https://api.openweathermap.org/data/2.5/uvi?appid=fa26494f744d903b68067a9947d31b33&lat=" + response.coord.lat + "&lon=" + response.coord.lat;
        $.ajax({
            url: uvURL,
            method: "GET"
...
function getForecast(city) {
    //get 5 day forecast
    var queryURL = "https://api.openweathermap.org/data/2.5/forecast?id=" + city + "&appid=fa26494f744d903b68067a9947d31b33&units=imperial";
    $.ajax({
        url: queryURL,
        method: "GET"
    }).then(function (response) {
